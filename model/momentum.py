...
if __name__ == '__main__':
    aapl_momentum = MomentumAgent('AAPL')
    aapl_momentum.loadStock()
    aapl_momentum.plotBuySellPoints(model=None, return_threshold=None, \
                                    days_topredict=None, filename='momentum_buysell.png')
    aapl_momentum.plotPortfolioReturn(model=None, return_threshold=None, \
                                      days_topredict=None, filename='momentum_return.png')
